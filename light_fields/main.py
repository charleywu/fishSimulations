...
# Additional tweaks and comments by Charley Wu (charleywu.github.io)

DEBUG = False
repetitions = 4
scales = [0.1, 0.25, 0.4] #Noise values
timeSteps = 200
#Environment size
nx = 110
ny = 110
#Charley Edit What do these mean?
xmin = 5
xmax = nx - xmin
ymin = 5
ymax = ny - ymin

#randomseed = np.random.randint(2**32 - 1)
randomseed = 569493822 #Charley Wu edit: fixed seed here for reproducability 
...
def main():
    ...
    if DEBUG:
        ...
        ids = map(str, range(repetitions)) #number of replications
